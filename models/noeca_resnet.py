...
class ECABasicBlock_no(nn.Module):
    expansion = 1

    def __init__(self, inplanes, planes, stride=1, downsample=None, k_size=3):
        super(ECABasicBlock_no, self).__init__()
...
def noeca_resnet18(k_size=[3, 3, 3, 3], num_classes=10, pretrained=False):
    ...
    """
    model = ResNet(ECABasicBlock_no, [2, 2, 2, 2], num_classes=num_classes, k_size=k_size)
    model.avgpool = nn.AdaptiveAvgPool2d(1)
    return model


def noeca_resnet34(k_size=[3, 3, 3, 3], num_classes=10, pretrained=False):
    ...
    Args:
        ...
        num_classes:The classes of classification
    """
    model = ResNet(ECABasicBlock_no, [3, 4, 6, 3], num_classes=num_classes, k_size=k_size)
    model.avgpool = nn.AdaptiveAvgPool2d(1)
    return model


def eca_resnet50(k_size=[3, 3, 3, 3], num_classes=10, pretrained=False):
...
def eca_resnet101(k_size=[3, 3, 3, 3], num_classes=10, pretrained=False):
...
def eca_resnet152(k_size=[3, 3, 3, 3], num_classes=10, pretrained=False):
