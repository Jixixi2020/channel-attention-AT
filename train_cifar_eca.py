...
def main():
    ...
    #---------------------------------------------------
        ...
        model = ResNet18()
    elif args.model == 'res18_eca':
        model = eca_resnet18()
    elif args.model == 'res34':
        model = ResNet34()
    elif args.model == 'res34_eca':
        model = eca_resnet34()
    elif args.model == 'res18_noeca':
        model = noeca_resnet18()
    elif args.model == 'res34_noeca':
        model = noeca_resnet34()
    elif args.model == 'res18_se':
        model = se_resnet18()
    elif args.model == 'res34_se':
        model = nose_resnet18()
    elif args.model == 'res18_nose':
        model = se_resnet34()
    elif args.model == 'res34_nose':
        model = nose_resnet34()
    #---------------------------------------------------
    else:
    ...
    for epoch in range(start_epoch, epochs):
        ...
        for i, batch in enumerate(test_batches):
            ...
            if args.attack == 'none':
                ...
                delta = attack_pgd(model, X, y, epsilon, pgd_alpha, 20, args.restarts, args.norm, early_stop=args.eval)
                #----------------------------------------------------------------------------------------------------------------------
            delta = delta.detach()
